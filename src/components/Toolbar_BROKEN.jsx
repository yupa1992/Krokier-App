...
import { Clock, Maximize, Minimize, Save, Upload, Lock, Unlock, Settings, MapPin, Download, Image as ImageIcon, FileText, Mail } from 'lucide-react'
import html2canvas from 'html2canvas'
import jsPDF from 'jspdf'

const Toolbar = ({ onSave, onLoad, onToggleFullscreen, isFullscreen, mapRef, symbols, drawings, images, isMapLocked, onToggleLock, onShowAdmin, logo }) => {
  ...
  const handleExportPNG = async () => {
      ...
      const mapElement = mapRef.current.getContainer ? mapRef.current.getContainer() : mapRef.current.container
      if (!mapElement) {
